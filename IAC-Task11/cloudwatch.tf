resource "aws_cloudwatch_metric_alarm" "high_cpu" {
  alarm_name          = "ecs-strapi-high-cpu-gov"
...
resource "aws_cloudwatch_dashboard" "strapi_dashboard" {
  dashboard_name = "strapi-dashboard-gov"
    ...
    widgets = [
      {
        ...
        height = 6,
        properties = {
          title = "ECS CPU Utilization (strapi-gov)",
          metrics = [
      ...
      },
      {
        ...
        height = 6,
        properties = {
          title = "ECS Memory Utilization (strapi-gov)",
          metrics = [
      ...
      },
      {
        ...
        height = 6,
        properties = {
          title = "Running Task Count (strapi-gov)",
          metrics = [
      ...
      },
      {
        ...
        height = 6,
        properties = {
          title = "Network In / Out (Bytes) (strapi-gov)",
          metrics = [
      ...
      },
      {
        ...
        height = 6,
        properties = {
          title = "ALB Target Response Time (strapi-gov)",
          metrics = [
      ...
      },
      {
        ...
        height = 6,
        properties = {
          title = "Target Group Health Check (strapi-gov)",
          metrics = [
