resource "aws_codedeploy_app" "strapi" {
  name = "strapi-codedeploy-gov"
  compute_platform = "ECS"
}

resource "aws_iam_role" "codedeploy_ecs_role" {
  name = "CodeDeployECSServiceRole-gov"
...
resource "aws_iam_role_policy_attachment" "codedeploy_ecs_role_attachment" {
...
resource "aws_codedeploy_deployment_group" "strapi_group" {
  ...
  deployment_group_name  = "strapi-dg-gov"
